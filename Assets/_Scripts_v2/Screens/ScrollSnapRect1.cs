...
public class ScrollSnapRect1 : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler {
    ...
    void Start() {
		...
		origPosition = _scrollRectRect.anchoredPosition;
	}
	...
	public void InitialieComponents() {
...
//			SetPageCount (sceneNames.Length);
//		}
		sceneIndex = 0;
//		_scrollRectComponent = GetComponent<ScrollRect>();
	}
	...
	void OnDisable() {
		if(_scrollRectRect != null)
			_scrollRectRect.anchoredPosition = origPosition;
	}
