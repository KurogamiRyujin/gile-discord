...
/// <summary>
/// Marker for the target fraction value on the stability number line.
/// </summary>
public class TargetMarker : MonoBehaviour {
	...
	//	void Update() {
	//		PointTo(this.numerator, this.denominator);
	//	}
    ...
    public void PointTo(float numerator, float denominator, int maxPoint) {
        ...
        Debug.LogError("MAX POINT OF TARGET IS "+maxPoint);
        Debug.LogError("length is " + this.length);
        Debug.LogError("num den is " + numerator+" / "+denominator);
        //if (maxPoint == -1 || maxPoint == 0)
        //    maxPoint = 0;
	...
	public void PostChangeEvent() {
		...
		EventBroadcaster.Instance.PostEvent (EventNames.TARGET_MARKER_CHANGED, parameters);
	}
