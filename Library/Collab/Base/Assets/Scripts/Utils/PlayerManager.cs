...
//			if(hasNeedle) {
				...
				// If up is pressed
			if (isUpPressed () && rb2d.velocity.y == 0) {
					jump ();
				}
...
//		if(other.gameObject.CompareTag("PartitionableObject") && !other.gameObject.GetComponent<PartitionableObject> ().IsTangible ()) {
