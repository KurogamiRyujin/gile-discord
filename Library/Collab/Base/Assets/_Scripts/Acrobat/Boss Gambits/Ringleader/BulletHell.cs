...
public class BulletHell : MonoBehaviour {
    ...
    /// <summary>
    /// Countdown before the Bullet Hell prompts the shooter to fire a Charm (formerly called a Yarnball).
    /// </summary>
	private int yarnballInterval = 4;
    /// <summary>
    /// Holder for the origial value of yarnballInterval.
    /// </summary>
	private int initialYarnballInterval = 4;
    /// <summary>
    ...
    /// <summary>
    /// List of denominators the Charms (formerly Yarnballs) are given.
    /// </summary>
	...
	private void FireShooter() {
		isCooldown = true;
		this.yarnballInterval--;
		this.rapidfireCounter++;
		if (this.rapidfireCounter == 5) {
			this.rapidfireCounter = 0;
		}
		if (this.yarnballInterval == 0) {
			this.yarnballInterval = this.initialYarnballInterval;
			bulletShooter.ShootYarnball (this.validDenominators[Random.Range(0, this.validDenominators.Count)]);
		} else {
    ...
    /// <summary>
    /// Yarnball interval setter.
    /// </summary>
    /// <param name="count"></param>
	public void SetYarnballInterval(int count) {
		this.yarnballInterval = count;
		this.initialYarnballInterval = this.yarnballInterval;
	}
    ...
    /// Denominators setter
    /// </summary>
    /// <param name="validDenominators"></param>
	public void SetValidDenominators(List<int> validDenominators) {
